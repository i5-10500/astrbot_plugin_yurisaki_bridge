...
isolated checklist in `docs/INTEGRATION_TESTING.md`; stable response facts are kept
in `docs/PROTOCOL_NOTES.md`. Never replace these files with raw logs; only add a real
fixture after it has been strictly sanitized.
